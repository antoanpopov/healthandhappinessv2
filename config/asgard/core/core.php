...
return [
   ...
   */
    'admin-assets' => [
        ...
        'daterangepicker.js' => ['module' => 'health:vendor/bootstrap-daterangepicker/daterangepicker.js'],
        ...
        'moment.js' => ['module' => 'health:vendor/moment.js/moment-with-locales.min.js'],
