 ...
 * Time: 18:04
 */
namespace Modules\Health\Traits;
trait Userstamps
{
    /**
    ...
    {
        static::creating('Modules\Health\Listeners\Creating@handle');
        static::updating('Modules\Health\Listeners\Updating@handle');
        if (static::usingSoftDeletes()) {
            static::deleting('Modules\Health\Listeners\Deleting@handle');
            static::restoring('Modules\Health\Listeners\Restoring@handle');
        }
    }
    /**
